	...
	<div class="limiter">
		<div class="container-login100" style="background-image: url('images/bg-01.jpg');">
			<div class="wrap-login100 p-t-30 p-b-50">
                ...
                name="form1" method="post" action="checkLogin.php">

					<div class="wrap-input100 validate-input" data-validate = "Enter username">
						<input class="input100" type="text" name="txtUsername" name="txtUsername"  placeholder="User name">
                    ...
                    <center><br><button type ="submit" class="login100-form-btn" name="save">
							Login
						</button>
				</form>
